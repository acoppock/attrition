...
- [`nobs(`*`<attrition_bounds>`*`)`](https://alexandercoppock.com/attrition/reference/nobs.attrition_bounds.md)
  [`nobs(`*`<attrition_trim>`*`)`](https://alexandercoppock.com/attrition/reference/nobs.attrition_bounds.md)
