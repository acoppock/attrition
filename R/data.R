...
#' on common ground (the moderate condition). Outcomes were measured immediately
#' in Wave 1 and again in a Wave 2 survey ten days later.
#'
#' Wave 2 is where the attrition happens, and it is what makes the data useful
#' here. Of the 1,980 subjects, 1,444 responded in Wave 2. Exactly 50
#' nonrespondents were then drawn at random from each condition and offered
#' $4.00 rather than the original $1.00 to participate. Of those 100 subjects,
#' 72 completed the survey. The follow-up sample is small, and that is the
#' point: because it is a random sample of the nonrespondents, the outcomes it
#' recovers stand in for the outcomes of every nonrespondent, and the worst-case
#' bounds narrow sharply.
#'
#' The experiment ran a third condition, a placebo group that read nothing on
#' the topic. It is not analyzed in the paper and is not shipped here, so the
#' data are the polarized-versus-moderate contrast the paper reports and nothing
#' else. \code{data-raw/levendusky_replication.R} builds them from the archive.
#'
#' @format A tibble with 1,980 rows and 10 columns:
#' \describe{
#'   \item{X_party_id}{Party identification: \code{Dem}, \code{Ind}, or
#'     \code{Rep}. The poststratification variable used in Table 3.}
#'   \item{Z_condition}{The condition as assigned: \code{Moderate} or
#'     \code{Polarized}.}
#'   \item{Z}{Polarized (1) versus moderate (0). The contrast analyzed
#'     throughout.}
#'   \item{R1}{Responded in the Wave 2 initial sample.}
#'   \item{Attempt}{Selected for the follow-up sample and offered the higher
#'     incentive.}
#'   \item{R2}{Responded to the follow-up attempt.}
#'   \item{Y_polarization_w1}{Perceived polarization at Wave 1, from 0 to 6.}
#'   \item{Y_polarization_w2}{Perceived polarization at Wave 2, from 0 to 6. The
#'     dependent variable throughout, and the one with missing values.}
#'   \item{Y_extremity_w1}{Perceived extremity at Wave 1, from 0 to 3.}
#'   \item{Y_extremity_w2}{Perceived extremity at Wave 2, from 0 to 3.}
#' }
#'
...
#'   Dataverse. \doi{10.7910/DVN/AQB4MP}, file 2887314
#'   (\code{levendusky_mturk_clean.csv}).
#'
#' @references
